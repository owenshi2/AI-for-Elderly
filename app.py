...
# <body {bStyle}>
# <div>
# <iframe src={MAIN_ROUTE} {iframe_dimensions}></iframe>
# </div>
# <button style="{button_style}" onclick="window.location.href='{CALEND_ROUTE}';">View Calendar</button>
# </body>
# '''



@app.get(f'{MAIN_ROUTE}', response_class=HTMLResponse)
...
# app = gr.mount_gradio_app(app, inp, path=MAIN_ROUTE)
